...
ifeq ($(wildcard out/config.py),)
    ...
    ADDL_TARGETS += bin/ble_simulation_run
endif
...
bin/ble_simulation_run: src/scripts/ble_simulation_run.in.py out/config.py
...
doxy:
	BLE_SIMULATION_VERSION=$(shell doc/version.sh) doxygen doxy.cfg

doxyshow: doxy
	xdg-open doc/doxy/index.html

formatting:
	bin/ble_simulation_format_code src

formatting-strict:
	bin/ble_simulation_format_code --strict src
